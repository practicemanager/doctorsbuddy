...
export default function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left branding panel */}
      <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center bg-gradient-to-br from-primary via-primary/90 to-secondary text-primary-foreground p-12">
        ...
        <div className="w-full max-w-md">
          ...
          {mode === "forgot" ? (
            ...
            <>
              ...
              <p className="text-muted-foreground mb-6">Sign in to your clinic dashboard</p>
            ...
            <>
              ...
              <p className="text-muted-foreground mb-6">Create your account and set up your clinic in minutes</p>
